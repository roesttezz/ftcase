...
JPM Coin is a digital, fiat currency that hopes to transform payments between institutional customers through the use of blockchain technology. It provides instantaneous payment at the same time as smart contracts' closure, which addresses the delayed settlement time faced by a traditional wire transfer option. The idea's origin is seen as JPMorgan Chase's attempt to catch up with the technological disruption in the finance industry, even when such an attempt goes against their own words of previous opposition to cryptocurrency. The announcement of JPM Coin makes JPMorgan Chase the pioneer of all large financial institutions in the U.S. fintech industry to ever do anything like the creation of their coin. While its future development is yet to be seen, this attempt brings hope to the firm in an attempt to better ensure the company's future in capturing technology disruption to the traditional finance landscape.
...
Because of JP Morgan's position as one of the largest banks in the world, JPM Coin can cover a huge market capitalization of stablecoin that may make the firm "*the largest stablecoin issuer on a blockchain*" with just one small and limited issuance. This naturally creates a competitive advantage for JPMorgan Chase but it is vital that the company must keep in mind that any other mega-banks of their size can do exactly the same to become JPM Coin's direct competitor.

![0.1% and 1% of JPMorgan Chase balance sheet in comparison with total stable coin market size](./images/market.png)
...
JPM Coin is a future payment solution for institutions, developing in the fintech domain of billing and payment. Even though it is considered as one of the most mature domains in the industry with multiple startups and continuous innovations, this particular domain is still in its early phase of development. The major players in such field may name Paypal, Stripe, Square, and many more.
...
JPMorgan Chase stated 4 reasons trying to convince the public why the company's involvement in payment method between banks and other institutions is a great idea. This also lines out a set of expectations for the coin to meet once it's out for use. Besides such outline, core metrics evaluating its performance can be quite familiar to cryptocurrencies' metrics, including but not limited to:
